...
**Output file:** `features.json` (repo root — this is what `/auto`, `/evaluate`, and `/review` read; do not write to `specs/features.json`)
...
| `features.json` (repo root) | Machine-readable feature list for evaluator |
